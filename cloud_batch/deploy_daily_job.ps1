...
try {
  gcloud run jobs deploy $JobName `
    ...
    --set-env-vars "PROJECT_ID=$ProjectId,BQ_DATASET=senior_reading_all,LIMIT=0,SLEEP_SEC=0.1,DOWNLOAD_THUMBNAILS=1,DISCOVER_RECENT_UPLOADS=1,DISCOVERY_UPLOADS_PER_CHANNEL=20,AVAILABILITY_CONFIRM_MISSES=2,THUMBNAIL_BUCKET=senior-share-staging-570862915709,THUMBNAIL_PREFIX=senior_reading_thumbnails" `
